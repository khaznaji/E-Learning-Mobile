...
public class ListCoursesFront extends AppCompatActivity {
    private AppDataBase appDatabase;
    private RecyclerView recyclerViewUsers;
    private CourseAdapterFront userAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAdapter = new CourseAdapterFront(new ArrayList<>());
        ...
        AsyncTask.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                if (userList.isEmpty()) {
                    ...
                    Toast.makeText(ListCoursesFront.this, "Table is empty", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void deleteComplaint (Courses courses){
        AsyncTask.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                Toast.makeText(ListCoursesFront.this, "course deleted", Toast.LENGTH_SHORT).show();
                loadUserList();
            });
            loadUserList();
