...
public class ComplaintAdapterFront extends RecyclerView.Adapter<ComplaintAdapterFront.UserViewHolder> {

    private List<complaint> userList;

    public ComplaintAdapterFront(List<complaint> userList) {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_article_front, parent, false);
